...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#020617] text-white flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden selection:bg-orange-500/30">
      {/* DEKORASI BACKGROUND */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(234,88,12,0.06)_0%,transparent_50%)]" />
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-orange-600/5 rounded-full blur-[100px] pointer-events-none" />
      
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 flex flex-col items-center">
        <Link href="/" className="mb-6 hover:opacity-95 transition-opacity">
          <Logo />
        </Link>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4">
        <div className="bg-slate-900/60 backdrop-blur-xl py-8 px-6 shadow-2xl border border-white/10 rounded-2xl sm:px-10">
          {error && (
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="px-2 bg-[#0c1122] text-slate-500 font-bold tracking-wider">Atau lanjutkan dengan</span>
              </div>
            </div>
